...
export declare type OnCloseCallback = (code: number, reason: string | null) => void;
export declare type OnConnectCallback = () => void;
export declare type SubscribeCallback = (content: string) => void;
export declare type RpCallSuccessCallback = (response: string) => void;
export declare type RpCallErrorCallback = (error: RpcCallErrorInterface) => void;
